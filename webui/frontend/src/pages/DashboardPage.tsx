...
import { Server, Clock, Terminal, Wifi, WifiOff, Send, Activity as AssessmentIcon, Cpu, Zap } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="stats shadow bg-base-100 border border-base-content/10">
          <div className="stat">
            ...
            <div className="stat-value text-primary text-2xl">{systemStatus?.status || "Unknown"}</div>
