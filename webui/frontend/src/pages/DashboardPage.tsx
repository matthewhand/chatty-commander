...
import { Server, Clock, Terminal, Wifi, WifiOff, Send, Activity as AssessmentIcon, Cpu, MemoryStick } from "lucide-react";
...
const DashboardPage: React.FC = () => {
  ...
  const { data: systemStatus, isLoading } = useQuery({
    ...
    refetchInterval: 5000, // Refresh more frequently for CPU/Memory
  });
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="stats shadow bg-base-100 border border-base-content/10">
          <div className="stat">
            ...
            <div className="stat-value text-accent text-2xl">{systemStatus?.commandsExecuted || 0}</div>
        ...
        <div className="stats shadow bg-base-100 border border-base-content/10">
          <div className="stat">
            ...
            <div className="stat-desc">RAM</div>
          </div>
        </div>
        ...
        <div className="stats shadow bg-base-100 border border-base-content/10">
          <div className="stat">
            ...
            <div className={`stat-value text-xl ${isConnected ? 'text-success' : 'text-error'}`}>
