  ...
  return (
    ...
    >
      ...
      <div className="form-control">
        <label className="label cursor-pointer justify-start gap-4" htmlFor={`action-type-${index}`}>
      ...
      {action.type === 'keypress' && (
        <div className="form-control">
          <label className="label cursor-pointer justify-start gap-4" htmlFor={`action-keys-${index}`}>
      ...
      {action.type === 'url' && (
        <div className="form-control">
          <label className="label cursor-pointer justify-start gap-4" htmlFor={`action-url-${index}`}>
      ...
      {action.type === 'shell' && (
        <div className="form-control">
          <label className="label cursor-pointer justify-start gap-4" htmlFor={`action-cmd-${index}`}>
      ...
      {action.type === 'custom_message' && (
        <div className="form-control">
          <label className="label cursor-pointer justify-start gap-4" htmlFor={`action-message-${index}`}>
