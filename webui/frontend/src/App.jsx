...
function App() {
  ...
  const checkServerConnectivity = async () => {
    try {
      ...
      if (reachable) {
        ...
        showNotification('Unable to connect to ChattyCommander server', 'warning');
      }
    } catch (error) {
  ...
  useEffect(() => {
    if (serverReachable === false) {
      ...
      const wasDisconnected = localStorage.getItem('chatty-commander-was-disconnected');
      if (wasDisconnected) {
        showNotification('Successfully connected to ChattyCommander server', 'success');
          ...
          <Toolbar>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', mr: 2 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                {serverReachable === null ? 'Checking...' :
                 serverReachable ? `Connected (v${appVersion})` : 'Disconnected'}
              </Typography>
            </Box>
            ...
            <Box sx={{ mt: 4 }}>
              ...
              >
                ...
                <Typography variant="body2">
                  Please ensure the ChattyCommander server is running on the expected port (default: 8100).
                  You can start the server by running: <code>python main.py --web</code>
                </Typography>
              </Alert>
            </Box>
          ) : (
