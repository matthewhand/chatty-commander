...
The **Commands** page in the WebUI provides a dynamic view of all configured commands and their associated wakewords, fetched directly from the system configuration.
