...
@pytest.fixture
def executor(config, model_manager, state_manager):
...
class TestCommandExecution:
    ...
    def test_pre_post_hooks(self, executor):
    ...
    def test_error_reporting(self, executor):
    ...
    def test_invalid_command_type(self, executor):
        """Test that a command with an invalid type raises a TypeError."""
        with pytest.raises(TypeError):
            executor.execute_command('invalid_type_cmd')
