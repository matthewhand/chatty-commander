...
class TestCommandExecution:
    ...
    @patch('command_executor.pyautogui', create=True)
    ...
    def test_url_command_failure(self, mock_requests, command_executor):
        ...
        command_executor._execute_url('lights_on', 'http://homeassistant.domain.home:8123/api/lights_on')
    ...
    def test_pre_post_hooks(self, command_executor):
        ...
        with patch.object(command_executor, 'pre_execute_hook') as mock_pre, \
