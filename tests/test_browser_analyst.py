...
def test_summarize_url_fallback():
    respx.get("https://example.com/error").mock(side_effect=httpx.RequestError("Network error"))
...
def test_browser_analyst_tool_fallback():
    respx.get("https://github.com/error").mock(side_effect=httpx.RequestError("Network error"))
    ...
    respx.get("https://stackoverflow.com/error").mock(side_effect=httpx.RequestError("Network error"))
