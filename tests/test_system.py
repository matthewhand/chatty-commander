...
# Ensure source directory is on the Python path so imports like
# ``from config import Config`` continue to work after the project's
# source was moved under ``src/``.
...
class SystemTester:
    ...
    def test_installation(self):
        ...
        modules = ['config', 'state_manager', 'model_manager', 'chatty_commander.app.command_executor', 'cli']
