...
# ---------------------------------------------------------------------------
# Tests migrated from test_avatar_ws.py (original single-test file)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Tests migrated from test_avatar_ws_no_clients.py
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Tests migrated from test_avatar_ws_theme.py
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Tests migrated from test_avatar_ws_comprehensive.py (imports fixed)
# ---------------------------------------------------------------------------
...
class TestAvatarWSConnectionManager:
    ...
    @patch("chatty_commander.web.routes.avatar_ws.get_thinking_manager")
    ...
    async def test_connect_websocket(self):
        ...
        with patch(
            "chatty_commander.web.routes.avatar_ws.get_thinking_manager",
