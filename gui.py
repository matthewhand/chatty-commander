...
class ChattyCommanderGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Button(self.bottom_frame, text="Save Config", command=self.save_config).pack(side=tk.LEFT, padx=5)
        ttk.Button(self.bottom_frame, text="Load Config", command=self.load_config_file).pack(side=tk.LEFT, padx=5)
        ttk.Button(self.bottom_frame, text="Reset to Defaults", command=self.reset_config).pack(side=tk.LEFT, padx=5)
    ...
    def create_url_commands_section(self):
        ...
        ttk.Button(url_btn_frame, text="Add URL Command", command=self.add_url_command).pack(side=tk.LEFT, padx=5)
        ttk.Button(url_btn_frame, text="Edit Selected", command=self.edit_url_command).pack(side=tk.LEFT, padx=5)
        ttk.Button(url_btn_frame, text="Delete Selected", command=self.delete_url_command).pack(side=tk.LEFT, padx=5)
        
        self.populate_url_commands()
    
    def create_keypress_commands_section(self):
        """Create keypress commands configuration section."""
        ttk.Label(self.keypress_frame, text="Keypress Commands", font=('Arial', 12, 'bold')).pack(pady=5)
        ...
        # Scrollbar
        keypress_scroll = ttk.Scrollbar(list_frame, orient=tk.VERTICAL, command=self.keypress_tree.yview)
        ...
        ttk.Button(keypress_btn_frame, text="Add Keypress Command", command=self.add_keypress_command).pack(side=tk.LEFT, padx=5)
        ttk.Button(keypress_btn_frame, text="Edit Selected", command=self.edit_keypress_command).pack(side=tk.LEFT, padx=5)
        ttk.Button(keypress_btn_frame, text="Delete Selected", command=self.delete_keypress_command).pack(side=tk.LEFT, padx=5)
        
        self.populate_keypress_commands()
    
    def create_system_commands_section(self):
        """Create system commands configuration section."""
        ttk.Label(self.system_frame, text="System Commands", font=('Arial', 12, 'bold')).pack(pady=5)
        ...
        # Scrollbar
        system_scroll = ttk.Scrollbar(list_frame, orient=tk.VERTICAL, command=self.system_tree.yview)
        ...
        ttk.Button(system_btn_frame, text="Add System Command", command=self.add_system_command).pack(side=tk.LEFT, padx=5)
        ttk.Button(system_btn_frame, text="Edit Selected", command=self.edit_system_command).pack(side=tk.LEFT, padx=5)
        ttk.Button(system_btn_frame, text="Delete Selected", command=self.delete_system_command).pack(side=tk.LEFT, padx=5)
    ...
    def create_states_tab(self):
        ...
        ttk.Label(self.states_frame, text="State Configuration", font=('Arial', 12, 'bold')).pack(pady=5)
        ...
        default_combo = ttk.Combobox(default_frame, textvariable=self.default_state_var, 
                                   values=['idle', 'chatty', 'computer'], state='readonly')
        default_combo.pack(side=tk.LEFT, padx=5)
        
        # State models configuration
        ttk.Label(self.states_frame, text="State Models", font=('Arial', 10, 'bold')).pack(pady=(20, 5))
        ...
        self.state_models_tree = ttk.Treeview(models_frame, columns=('Models',), show='tree headings')
        ...
        # Scrollbar
        models_scroll = ttk.Scrollbar(models_frame, orient=tk.VERTICAL, command=self.state_models_tree.yview)
        ...
        ttk.Button(models_btn_frame, text="Edit State Models", command=self.edit_state_models).pack(side=tk.LEFT, padx=5)
    ...
    def create_models_tab(self):
        ...
        ttk.Label(self.models_frame, text="Model Configuration", font=('Arial', 12, 'bold')).pack(pady=5)
        ...
        ttk.Entry(chatty_frame, textvariable=self.chatty_path_var, width=40).pack(side=tk.LEFT, padx=5)
        ttk.Button(chatty_frame, text="Browse", command=lambda: self.browse_directory(self.chatty_path_var)).pack(side=tk.LEFT)
        ...
        ttk.Entry(computer_frame, textvariable=self.computer_path_var, width=40).pack(side=tk.LEFT, padx=5)
        ttk.Button(computer_frame, text="Browse", command=lambda: self.browse_directory(self.computer_path_var)).pack(side=tk.LEFT)
        ...
        ttk.Button(idle_frame, text="Browse", command=lambda: self.browse_directory(self.idle_path_var)).pack(side=tk.LEFT)
        ...
        ttk.Radiobutton(framework_frame, text="ONNX", variable=self.framework_var, value="onnx").pack(side=tk.LEFT, padx=10)
        ttk.Radiobutton(framework_frame, text="OpenVINO", variable=self.framework_var, value="openvino").pack(side=tk.LEFT, padx=10)
    ...
    def create_audio_tab(self):
        ...
        self.sample_rate_var = tk.StringVar(value=str(self.config.audio_settings.get('sample_rate', 16000)))
        ttk.Entry(rate_frame, textvariable=self.sample_rate_var, width=10).pack(side=tk.LEFT, padx=5)
        ...
        ttk.Entry(channels_frame, textvariable=self.channels_var, width=10).pack(side=tk.LEFT, padx=5)
        ...
        self.chunk_size_var = tk.StringVar(value=str(self.config.audio_settings.get('chunk_size', 1024)))
        ttk.Entry(chunk_frame, textvariable=self.chunk_size_var, width=10).pack(side=tk.LEFT, padx=5)
    ...
    def create_service_tab(self):
        ...
        ttk.Label(self.service_frame, text="Service Control", font=('Arial', 12, 'bold')).pack(pady=5)
        
        # Service status
        status_frame = ttk.LabelFrame(self.service_frame, text="Status")
        status_frame.pack(fill=tk.X, padx=5, pady=5)
        
        self.status_label = ttk.Label(status_frame, text="Service Status: Stopped", font=('Arial', 10))
        ...
        self.start_btn = ttk.Button(controls_frame, text="Start Service", command=self.start_service)
        self.start_btn.pack(side=tk.LEFT, padx=5)
        
        self.stop_btn = ttk.Button(controls_frame, text="Stop Service", command=self.stop_service, state=tk.DISABLED)
...
class StateModelsDialog:
    ...
    def __init__(self, parent, state_models):
        ...
        for state in ['idle', 'chatty', 'computer']:
            ...
            ttk.Label(frame, text="(Comma-separated list of model paths)", font=('Arial', 8)).pack(padx=5)
