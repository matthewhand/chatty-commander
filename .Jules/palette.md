...
## 2026-03-19 - Proper Label Associations
**Learning:** Forms frequently omit explicit `htmlFor` and `id` linking between labels and inputs, breaking screen reader experience.
**Action:** Always verify `htmlFor` maps correctly to an `id` attribute when updating forms.
