...
export default function SidecarPane() {
  const [avatarStatus, setAvatarStatus] = useState<'idle' | 'launching' | 'running' | 'error'>('idle');
  ...
  const getStatusMessage = () => {
    switch (avatarStatus) {
      case 'launching': return 'Launching avatar...';
      case 'running': return 'Avatar launched successfully!';
      case 'error': return 'Failed to launch avatar. Check console.';
      default: return '';
    }
  };
  ...
  return (
    <section className="h-full p-2 bg-gray-900 space-y-4">
      <div>
        ...
        <div className="space-y-3">
          <p className="text-sm text-gray-300">
            Launch a transparent desktop avatar that displays AI states and animations.
          </p>
      ...
      <div>
        ...
        <div className="text-sm text-gray-400">Open files and notes will appear here.</div>
      </div>
    </section>
  );
}
