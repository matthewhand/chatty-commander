...
class WebModeServer:
    ...
    def __init__(self, config_manager: Config, state_manager: StateManager, 
                 model_manager: ModelManager, command_executor: CommandExecutor,
    ...
    def _create_app(self) -> FastAPI:
        ...
        if frontend_path.exists():
            ...
            async def serve_frontend():
                ...
                return HTMLResponse("<h1>ChattyCommander</h1><p>Frontend not built. Run <code>npm run build</code> in webui/frontend/</p>")
    ...
    def _register_routes(self, app: FastAPI) -> None:
        ...
        async def update_config(config_data: Dict[str, Any]):
            ...
            try:
                ...
                await self._broadcast_message(WebSocketMessage(
                    type="config_updated",
    ...
    def _on_state_change(self, old_state: str, new_state: str) -> None:
        ...
        try:
            ...
            if loop.is_running():
                asyncio.create_task(self._broadcast_message(WebSocketMessage(
                    type="state_change",
                    data={
                        "old_state": old_state,
                        "new_state": new_state,
...
def create_web_server(config_manager: Config, state_manager: StateManager,
                     model_manager: ModelManager, command_executor: CommandExecutor,
                     no_auth: bool = False) -> WebModeServer:
